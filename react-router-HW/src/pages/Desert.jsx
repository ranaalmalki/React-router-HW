...
function Desert() {
  return (
    <div>
        <Homepage
        img="https://upload.wikimedia.org/wikipedia/commons/3/34/Rub_al_Khali_002.JPG"
        name="Rub' al Khali"
        content="vast desert region in the southern Arabian Peninsula, constituting the largest portion of the Arabian Desert. It covers an area of about 250,000 square miles (650,000 square km) in a structural basin lying mainly in southeastern Saudi Arabia, with lesser portions in Yemen, Oman, and the United Arab Emirates.
Rubʿ al-Khali sand desert
Rubʿ al-Khali sand desertThe Rubʿ al-Khali sand desert, most of which lies within Saudi Arabia.
